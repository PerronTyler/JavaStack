package com.tyler.travelers.controllers;
...
import com.tyler.travelers.models.LoginUser;
import com.tyler.travelers.models.User;
import com.tyler.travelers.services.UserService;
...
//		check if passwords match 
		if(!user.getPassword().equals(user.getConfirm())) {
			result.rejectValue("password", "Match" ,"password and confirm password not matching");
		}
